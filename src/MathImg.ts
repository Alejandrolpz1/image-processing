...
export class MathImg {
  ...
  */
  ...
  public static superponerRuidoBordes(img: ImageType, borderWidth: number): number[][][] {
...
public static efectoAcuarela(arrImage: number[][][]): number[][][] {
